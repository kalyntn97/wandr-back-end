...
router.patch('/:postId/main-photo', checkAuth, postsCtrl.addMainPhoto)
router.patch('/:postId/photos', checkAuth, postsCtrl.addMorePhotos)
router.delete('/:postId/delete-main-photo', checkAuth, postsCtrl.deleteMainPhoto)
// router.delete('/:postId/delete-more-photos/:photoId', checkAuth, postsCtrl.deleteMorePhotos)
